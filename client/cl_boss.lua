...
RegisterNetEvent('kg-bossmenu:client:OpenMenu', function()
    ...
    local bossMenu = {
        ...
        },
        {
            ...
            params = {
                event = 'kg-bossmenu:client:employeelist',
            }
        },
        {
            ...
            params = {
                event = 'kg-bossmenu:client:HireMenu',
            }
        },
        {
            ...
            params = {
                isServer = true,
                event = 'kg-bossmenu:server:stash',
            }
        },
        {
            ...
            params = {
                event = 'kg-bossmenu:client:Wardrobe',
            }
        }
    }
    ...
    exports['kg-menu']:openMenu(bossMenu)
end)

RegisterNetEvent('kg-bossmenu:client:employeelist', function()
    local EmployeesMenu = {
        {
    ...
    KGCore.Functions.TriggerCallback('kg-bossmenu:server:GetEmployees', function(cb)
        for _, v in pairs(cb) do
            EmployeesMenu[#EmployeesMenu + 1] = {
                ...
                params = {
                    event = 'kg-bossmenu:client:ManageEmployee',
                    args = {
                        player = v,
                        work = PlayerJob
                    }
        ...
        EmployeesMenu[#EmployeesMenu + 1] = {
            ...
            icon = 'fa-solid fa-angle-left',
            params = {
                event = 'kg-bossmenu:client:OpenMenu',
            }
        }
        exports['kg-menu']:openMenu(EmployeesMenu)
    end, PlayerJob.name)
end)

RegisterNetEvent('kg-bossmenu:client:ManageEmployee', function(data)
    local EmployeeMenu = {
        {
    ...
    for k, v in pairs(KGCore.Shared.Jobs[data.work.name].grades) do
        EmployeeMenu[#EmployeeMenu + 1] = {
            header = v.name,
            txt = Lang:t('body.grade') .. k,
            params = {
                isServer = true,
                event = 'kg-bossmenu:server:GradeUpdate',
    ...
    EmployeeMenu[#EmployeeMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = 'kg-bossmenu:server:FireEmployee',
    ...
    exports['kg-menu']:openMenu(EmployeeMenu)
end)

RegisterNetEvent('kg-bossmenu:client:Wardrobe', function()
    TriggerEvent('kg-clothing:client:openOutfitMenu')
end)

RegisterNetEvent('kg-bossmenu:client:HireMenu', function()
    local HireMenu = {
        {
    ...
    KGCore.Functions.TriggerCallback('kg-bossmenu:getplayers', function(players)
        for _, v in pairs(players) do
            if v and v ~= PlayerId() then
                HireMenu[#HireMenu + 1] = {
                    ...
                    params = {
                        isServer = true,
                        event = 'kg-bossmenu:server:HireEmployee',
                        args = v.sourceplayer
                    }
                }
            end
        ...
        exports['kg-menu']:openMenu(HireMenu)
    end)
end)
                            ...
                            if #(pos - coords) < 5.0 then
                                ...
                                if #(pos - coords) <= 1.5 then
                                    ...
                                    if not shownBossMenu then
                                        exports['kg-core']:DrawText(Lang:t('drawtext.label'), 'left')
                                        shownBossMenu = true
                                    end
                                    if IsControlJustReleased(0, 38) then
                                        exports['kg-core']:HideText()
                                        TriggerEvent('kg-bossmenu:client:OpenMenu')
                                    end
                                end
